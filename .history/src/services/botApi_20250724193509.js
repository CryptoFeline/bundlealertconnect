...
/**
 * Get comprehensive user status including wallets and tier info
 */
export const getUserComprehensiveStatus = async () => {
  try {
    ...
    console.error('Failed to get user comprehensive status:', error)
    handleApiError(error)
  }
}

/**
 * Disconnect wallet(s) from user account
 */
