    ...
    return (
      <Card className="p-6 text-center border-green-200 bg-green-50">
        ...
        <p className="text-green-800 text-sm mb-4">
          Your wallet has been successfully verified and your tier has been assigned.
        </p>
            ...
            <button
              onClick={async () => {
                try {
                  ...
                  // Create enhanced alert using safe DOM manipulation
                  ...
                  statusDiv.className = 'mt-3 p-2 rounded text-gray-300 bg-gray-700'
                  
                  const statusText = !hasTelegram ? '⚠️ Not running in Telegram WebApp context' : 
