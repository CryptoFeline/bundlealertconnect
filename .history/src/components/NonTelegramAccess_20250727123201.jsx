    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-100 flex items-center justify-center p-4">
      ...
      >
        ...
        <motion.div
          ...
          className="mx-auto mb-6 w-20 h-20 bg-blue-500 rounded-full flex items-center justify-center"
        >
        ...
        >
          ...
          <ol className="text-sm text-blue-800 space-y-1 text-left">
            ...
            <li>2. Find the BundleAlert bot</li>
        ...
        <motion.a
          ...
          href="https://t.me/BundleAlertBot"
          target="_blank"
        ...
        >
          This security measure ensures your wallet verification is authenticated through Telegram.
        </motion.p>
      </motion.div>
    </div>
  )
